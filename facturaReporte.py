...
class PDF(FPDF):
    ...
    def header(self):
        ...
        tfont_size(self,14)
        tfont(self,'B')
        self.cell(w = 35, h = 10, txt = '', border = 0,
                align = 'C', fill = 0)
        self.cell(w = 65, h = 10, txt = 'Factura', border = 0,
                align = 'L', fill = 0)
        self.multi_cell(w = 0, h = 10, txt = 'No. 001-002-000001729', border = 0,
                align = 'L', fill = 0)
        ...
        self.cell(w = 35, h = 10, txt = '', border = 0,
                align = 'C', fill = 0)
        self.cell(w = 65, h = 10, txt = 'Número de autorización', border = 0,
                align = 'L', fill = 0)
        self.multi_cell(w = 0, h = 5, txt = '0602202401099288649800120010020000017293941061611', border = 0,
                align = 'L', fill = 0)
        self.cell(w = 35, h = 10, txt = '', border = 0,
                align = 'C', fill = 0)
        self.cell(w = 65, h = 10, txt = 'Fecha de autorización', border = 0,
                align = 'L', fill = 0)
        self.multi_cell(w = 0, h = 10, txt = '06/02/2024  15:09:21', border = 0,
                align = 'L', fill = 0)
        ...
        tcol_set(self, 'black')
        tfont(self,'B')
        self.cell(w = 25, h = 5, txt = 'Emisor:', border = 0,
                align = 'L', fill = 0)
        
        tfont_size(self,10)
        tcol_set(self, 'black')
        tfont(self,'')
        self.cell(w = 90, h = 5, txt = 'Universidad Laica Vicente Rocafuerte de Guayaquil', border = 0,
                align = 'L', fill = 0)
        
        tfont_size(self,10)
        tcol_set(self, 'black')
        tfont(self,'B')
        self.cell(w = 35, h = 5, txt = 'Ambiente:', border = 0,
                align = 'L', fill = 0)
        
        tfont_size(self,10)
        tcol_set(self, 'black')
        tfont(self,'')
        self.multi_cell(w = 0, h = 5, txt = 'PRODUCCION', border = 0,
                align = 'L', fill = 0)
        ...
        tcol_set(self, 'black')
        tfont(self,'')
        self.cell(w = 90, h = 5, txt = 'Ave. de las Américas s/n frente al', border = 0,
                align = 'L', fill = 0)
        ...
        tcol_set(self, 'black')
        tfont(self,'')
        self.cell(w = 90, h = 5, txt = 'Cuartel Modelo AP 11-33 Guayaquil, Ecuador', border = 0,
                align = 'L', fill = 0)
        ...
        tcol_set(self, 'black')
        tfont(self,'')
        self.cell(w = 90, h = 5, txt = '+593 4 259 6500', border = 0,
                align = 'L', fill = 0)
        ...
        tcol_set(self, 'black')
        tfont(self,'B')
        self.cell(w = 60, h = 5, txt = 'Obligado a llevar contabilidad:', border = 0,
                align = 'L', fill = 0)
...
tfont_size(pdf,10)
tfont(pdf,'B')
pdf.multi_cell(w = 0, h = 10, txt = 'Cliente / Usuario', border = 0,
         align = 'C', fill = 1)
tfont(pdf,'')
...
tfont_size(pdf,12)
tfont(pdf,'B')
pdf.cell(w = 0, h = 15, txt = 'Detalle Factura', border = 0,ln = 2, align = 'C', fill = 1)
tfont(pdf,'')

tfont_size(pdf,9)
bcol_set(pdf, 'blue')

pdf.cell(w = 15, h = 10, txt = 'Código', border = 0, align = 'C', fill = 1)
pdf.cell(w = 15, h = 10, txt = 'Cantidad', border = 0, align = 'C', fill = 1)
pdf.cell(w = 70, h = 10, txt = 'Descripción', border = 0, align = 'C', fill = 1)
pdf.cell(w = 40, h = 10, txt = 'Detalles Adicionales', border = 0, align = 'C', fill = 1)
pdf.cell(w = 15, h = 10, txt = 'P. Unitario', border = 0, align = 'C', fill = 1)
pdf.cell(w = 15, h = 10, txt = 'Dscto', border = 0, align = 'C', fill = 1)
pdf.multi_cell(w = 0, h = 10, txt = 'Total', border = 0, align = 'C',
             fill = 1)
...
dcol_set(pdf, 'blue')
tcol_set(pdf, 'gray')
pdf.rect(x= 10, y= 10, w= 190, h= 118)
c = 0
